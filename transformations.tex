...
\end{equation*}
Also by the induction hypothesis, it is $t_{\epsilon_{n-1}}[\sigma^{n-1}_v] = q_\zeta[\sigma'^{n' +1}_v] = q_{\epsilon_n}[\sigma'^{n}_v]$ for a $\sigma'^{n}_v$; thus choose $\sigma^{n}_v = \sigma'^{n}_v$. 
\item
\end{enumerate}
