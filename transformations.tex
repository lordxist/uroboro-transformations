...
Alternative definition for $disentangle_r$, not quite equivalent, but with the resulting fragment being the same. This definition is to be used for the simplified proofs.

$disentangle_r = step2 \circ step1$

$step1 = extract\_helpers(extract\_patterns)$ (TODO: needs slight modification of $extract\_patterns$ such that all destructor patterns are targeted)
