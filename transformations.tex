...
If at least (a) is true, the function name of $q$ is different from $fun$, as well, because $q \sim q_r$. (TODO: This is an important property of the equivalence relation. Such intended properties need to be noted before defining the equivalence relation.) But then $s^0$ wouldn't match $q$, contrary to the assumption.
