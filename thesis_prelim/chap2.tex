...
\UnaryInfC{$fun \lhd | ~ (fun(x, y))$}
\RightLabel{\scriptsize C\textsubscript{Con}}
\UnaryInfC{$fun \lhd | ~ (fun(a1(), y) ~ fun(a2(x), y))$}
\RightLabel{\scriptsize C\textsubscript{Con}}
\UnaryInfC{$fun \lhd | ~ (fun(a1(), b1(x)) ~ fun(a1(), b2()) ~ fun(a2(x), y))$}
\RightLabel{\scriptsize C\textsubscript{Des}}
\UnaryInfC{$fun \lhd | ~ (fun(a1(), b1(x)) ~ fun(a1(), b2()) ~ fun(a2(x), y).d1() ~ fun(a2(x), y).d2(z))$}
\end{prooftree}
