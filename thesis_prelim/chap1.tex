...
Rendel et al. intend the Data Fragment and the Codata Fragment to be fragments of a common language, called Uroboro. In the following chapter, we define this language in full for the first time. Here, we motivate why we think Uroboro is interesting and relate this to the contributions of this work.
...
\end{itemize}
We aren't aware of any existing languages which have both of these properties. Regarding the second property, one of the contributions of this work is to extend defunctionalization and refunctionalization to all of Uroboro.
