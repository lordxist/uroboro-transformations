...
\begin{lemma}[Commuting-diamond property]
...
\[
a {\longrightarrow'}^n b \land a {\longrightarrow^{aux}}^* c \implies \exists d . b {\longrightarrow^{aux}}^* d \land c {\longrightarrow'}^n d
\]
...
\begin{proof}
``$\Rightarrow$'': By induction on the length of $s {\longrightarrow'}_{\langle prg \rangle}^* t$.
