...
\begin{lemma}[Correctness of translation `A']
...
then
\[
s^c_1 \longrightarrow_{\langle prg \rangle} ... \longrightarrow_{\langle prg \rangle} s^c_m \sim t
\]
...
\begin{lemma}[Correctness of translation `B']
Translation `B' is correct, that is, when
\[
s = s_1 {\longrightarrow'}_{\langle prg \rangle} ... {\longrightarrow'}_{\langle prg \rangle} s_n \sim t
\]
then
\[
