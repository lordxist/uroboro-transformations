...
We give a number of example extractions. The two following extractions will be used in the next chapter.
...
\sigma^{q^c}_\pi(q^a) = \begin{cases}
                              ...
                              \end{cases}
\]
With $\texttt{get} = \pi$ and $\putback(q^a, q^c) = \sigma^{q^c}_\pi(q^a)$ we have the $\pi$-lens. We would like to illustrate with a little Haskell implementation how straightforward the two parts of the lens fit together.
