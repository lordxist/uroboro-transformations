...
\begin{frame}[fragile, shrink]
  {(De|Re)functionalization}
    ...
    !\tikzmark{succ2}{function succ(x): Nat}! where
      succ(x).add(y) = succ(x.add(y))
    \end{lstlisting}
    \end{block}

    \tikz[overlay,remember picture]{\draw<2>[draw=red,thick,fill opacity=0.2] ($(nat1)+(-0.5,0.4)$) rectangle ($(nat1)+(6,-0.2)$);}
    \tikz[overlay,remember picture]{\draw<2>[draw=red,thick,fill opacity=0.2] ($(nat2)+(-0.5,0.4)$) rectangle ($(nat2)+(6,-0.2)$);}
    \tikz[overlay,remember picture]{\draw<3>[draw=red,thick,fill opacity=0.2] ($(zero1)+(-0.5,0.4)$) rectangle ($(zero1)+(6,-0.2)$);}
    \tikz[overlay,remember picture]{\draw<3>[draw=red,thick,fill opacity=0.2] ($(zero2)+(-0.5,0.4)$) rectangle ($(zero2)+(6,-0.2)$);}
    \tikz[overlay,remember picture]{\draw<4>[draw=red,thick,fill opacity=0.2] ($(succ1)+(-0.5,0.4)$) rectangle ($(succ1)+(6,-0.2)$);}
    \tikz[overlay,remember picture]{\draw<4>[draw=red,thick,fill opacity=0.2] ($(succ2)+(-0.5,0.4)$) rectangle ($(succ2)+(6,-0.2)$);}
    \tikz[overlay,remember picture]{\draw<5>[draw=red,thick,fill opacity=0.2] ($(add1)+(-0.5,0.4)$) rectangle ($(add1)+(6,-0.2)$);}
    \tikz[overlay,remember picture]{\draw<5>[draw=red,thick,fill opacity=0.2] ($(add2)+(-0.5,0.4)$) rectangle ($(add2)+(6,-0.2)$);}
\end{frame}
